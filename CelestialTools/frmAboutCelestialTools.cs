...
namespace CelestialTools
{
    internal partial class frmAbout : Form
    {
        ...
        private void frmAbout_Load(object eventSender, EventArgs eventArgs)
        {
            ...
            lblVersion.Text = "Celestial Tools Version " + My.MyProject.Application.Info.Version.Major.ToString("00") + " - " + My.MyProject.Application.Info.Version.Minor.ToString("00") + " - " + My.MyProject.Application.Info.Version.Build.ToString("0000") + " - " + My.MyProject.Application.Info.Version.Revision.ToString("0000") + Environment.NewLine + ".NET Version:" + Environment.Version.ToString(); // Month of update
